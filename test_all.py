...
import Safari.safari_testing as safariTesting
...
def run_all_tests():
    ...
    print("\nTesting Safari:\n")
    safari_result = safariTesting.testSafari()
    print("\nTesting Firefox:\n")
    ...
    return (
        v8_result == True
        and firefox_result == True
        and chrome_result == True
        and safari_result == True
    )
